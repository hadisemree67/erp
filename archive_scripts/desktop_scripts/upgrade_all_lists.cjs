/*
 * ÖZET:
 * Bu script, masaüstü uygulamasındaki çeşitli liste bileşenlerine (Müşteriler, 
 * Tedarikçiler vb.) modern tablo stilleri ve boş durum (empty state) görünümleri uygular.
 */
const fs = require('fs');
