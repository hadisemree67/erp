/*
 * ÖZET:
 * Bu script, InventoryEntry bileşenindeki "Birim Fiyat" ve "SKT" gibi 
 * eski alanları, "Raf Ömrü" ve "Tedarik Süresi" olarak günceller.
 */
const fs = require('fs');
let code = fs.readFileSync('src/components/WMS/InventoryEntry.jsx', 'utf8');

// State değişkenlerini değiştir
code = code.replace(/PurchasePrice: '',/g, "shelf_life_months: '',");
code = code.replace(/ExpirationDate: '',/g, "lead_time_days: '',");

// Arayüz bloklarını değiştir
