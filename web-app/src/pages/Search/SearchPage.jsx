  ...
  return (
    <div className={styles.pageWrapper}>
      <div className={styles.container}>
        ...
        {/* Breadcrumb was moved or just keep a simple one without banner */}
        <div style={{ padding: '20px 0 0 0', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#6b7280' }}>
          <Link to="/" style={{ color: '#6b7280', textDecoration: 'none' }}>Ana Sayfa</Link>
        ...
        <div className={styles.contentLayout}>
          ...
          <main className={styles.mainContent}>
            ...
            <div className={styles.header}>
              <h2 className={styles.pageTitle} style={{ fontWeight: '500' }}>{pageHeading.toUpperCase()}</h2>
            </div>
