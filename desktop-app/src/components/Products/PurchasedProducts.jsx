    ...
    const fetchProducts = async () => {
        try {
            ...
            if (Array.isArray(data)) {
                // Sadece satın alınanları (PURCHASE) filtrele
                const purchased = data.filter(p => p.supply_type === 'PURCHASE');
    ...
    return (
        <div style={{ padding: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                <div>
                    <h1 style={{ color: '#0f172a', fontFamily: 'Inter, sans-serif', fontSize: '24px', fontWeight: 'bold', margin: 0 }}>Ticari Ürünler (Satın Al)</h1>
                    <p style={{ color: '#64748b', marginTop: '4px', fontSize: '14px' }}>Dışarıdan hazır aldığınız (Satın Alınan) ürünlerin stok takibini yapın ve sipariş verin.</p>
                </div>
            </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                            ...
                            <tbody>
                                {filteredProducts.length === 0 ? (
                                    <tr><td colSpan="5" style={{ padding: '24px', textAlign: 'center', color: '#94a3b8' }}>Ticari ürün bulunamadı.</td></tr>
                ...
                <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(15, 23, 42, 0.6)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000, padding: '20px' }}>
                    <div style={{ backgroundColor: 'white', borderRadius: '16px', width: '100%', maxWidth: '400px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', overflow: 'hidden' }}>
                        <div style={{ padding: '20px 24px', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 'bold', color: '#0f172a' }}>Satın Alma Talebi</h2>
