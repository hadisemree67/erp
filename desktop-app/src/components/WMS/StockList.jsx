                    ...
                    <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '16px', width: '90%', maxWidth: '650px', maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' }}>
                        ...
                        {capacityData && capacityData.hasFormula && (
                            <div style={{ marginBottom: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                ...
                                <div style={{ padding: '16px', backgroundColor: '#f0fdf4', borderRadius: '12px', border: '1px solid #bbf7d0' }}>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px' }}>
                                        <div style={{ backgroundColor: 'white', padding: '12px', borderRadius: '8px', border: '1px solid #dcfce7' }}>
                                            <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase' }}>Makine Min. Üretim</div>
                                            <div style={{ fontSize: '20px', fontWeight: '800', color: '#0f172a', marginTop: '4px' }}>
                                                {capacityData.capacity.minFromMachine !== null ? `${capacityData.capacity.minFromMachine} Adet` : 'Belirsiz'}
                                            </div>
                                            <div style={{ fontSize: '10px', color: '#94a3b8', marginTop: '2px' }}>Makineler minimum bu kadar üretmeli</div>
                                        </div>
                                        <div style={{ backgroundColor: 'white', padding: '12px', borderRadius: '8px', border: '1px solid #dcfce7' }}>
                                            <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase' }}>Makine Maks. Üretim</div>
                                            <div style={{ fontSize: '20px', fontWeight: '800', color: '#0f172a', marginTop: '4px' }}>
                                                {capacityData.capacity.maxFromMachine !== null ? `${capacityData.capacity.maxFromMachine} Adet` : 'Belirsiz'}
                                            </div>
                                            <div style={{ fontSize: '10px', color: '#94a3b8', marginTop: '2px' }}>Tek seferde en fazla bu kadar</div>
                                        </div>
                                        <div style={{ backgroundColor: 'white', padding: '12px', borderRadius: '8px', border: '1px solid #dcfce7' }}>
                                            <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase' }}>Hammadde Yeterlilik</div>
                                            <div style={{ fontSize: '20px', fontWeight: '800', color: capacityData.capacity.maxFromMaterials === 0 ? '#dc2626' : '#0f172a', marginTop: '4px' }}>
                                                {capacityData.capacity.maxFromMaterials !== null ? `${capacityData.capacity.maxFromMaterials} Adet` : 'Hesaplanamadı'}
                                            </div>
                                            <div style={{ fontSize: '10px', color: '#94a3b8', marginTop: '2px' }}>Mevcut stokla üretilebilir</div>
                                        </div>
                                        <div style={{ backgroundColor: '#f0f9ff', padding: '12px', borderRadius: '8px', border: '1px solid #bae6fd' }}>
                                            <div style={{ fontSize: '11px', color: '#0369a1', fontWeight: '600', textTransform: 'uppercase' }}>💡 Önerilen Aralık</div>
                                            <div style={{ fontSize: '20px', fontWeight: '800', color: '#0369a1', marginTop: '4px' }}>
                                                {capacityData.capacity.recommendedMin} - {capacityData.capacity.recommendedMax > 99000 ? '∞' : capacityData.capacity.recommendedMax}
                                            </div>
                                            <div style={{ fontSize: '10px', color: '#94a3b8', marginTop: '2px' }}>Optimum talep miktarı</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Uyarı */}
                                {capacityData.capacity.maxFromMaterials !== null && capacityData.capacity.maxFromMaterials === 0 && (
                                    <div style={{ padding: '10px 14px', backgroundColor: '#fef2f2', borderRadius: '10px', border: '1px solid #fecaca', color: '#991b1b', fontSize: '12px', fontWeight: '600' }}>
                        ...
                        {capacityData && !capacityData.hasFormula && (
                            <div style={{ padding: '12px', backgroundColor: '#fffbeb', borderRadius: '10px', border: '1px solid #fde68a', marginBottom: '16px', color: '#92400e', fontSize: '13px', fontWeight: '600' }}>
