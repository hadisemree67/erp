...
// Replace formData usage in input values (lines 1115 and 1162)
...
// Replace mapping to form data submission
// Find formData.unitPrice to formData.shelf_life_months
